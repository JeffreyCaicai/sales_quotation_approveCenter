  ...
  test("rejects duplicate prices and duplicate package memberships", () => {
    try {
      ...
      expect((error as RateCardBuildingResolutionError).errors).toEqual([
        ...
        { sheet: "Package Membership", rowNumber: 3, column: "IRIS Building ID", key: "import.error.rate_card_membership_duplicate", params: { irisBuildingId: "B000002", packageCode: "PKG-A" } },
        { sheet: "Package Membership", rowNumber: 9, column: "IRIS Building ID", key: "import.error.rate_card_membership_duplicate", params: { irisBuildingId: "B000002", packageCode: "PKG-A" } },
      ]);
    }
  });
});
